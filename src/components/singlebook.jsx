...
export default function SingleBook({ book }) {
  ...
  return (
    <div className={`col-lg-3 col-md-4 col-sm-6 mb-4 ${selected ? 'border border-danger' : ''}`}>
      <div className="card h-100 d-flex flex-column">
        <img src={book.img} className="card-img-top" alt={book.title} style={{ maxHeight: "400px" }} onClick={handleClick} />
